...
public class CompetitionDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        competitionRepository.saveAll(List.of(
                new Competition("CO49863283", "Super League Greece",
                ...
                new Competition("CO53612495", "Greek Football Cup",
                ...
                new Competition("CO69590241", "Greek Super Cup",
                ...
                new Competition("CO15230140", "Champions League",
