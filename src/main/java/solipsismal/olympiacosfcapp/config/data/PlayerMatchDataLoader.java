    ...
    public void run(String... args) throws PlayerNotFoundException {
        ...
        List<PlayerMatch> playerMatches23141225 = List.of(
                ...
                new PlayerMatch("PM11464366", players.get("El Kaabi"), match23141225,
                        0, 0, 0, 0, 85),
                new PlayerMatch("PM12309427", players.get("Hezze"), match23141225,
                        0, 0, 0, 0, 34),
        ...
        // Match 25 | OLYMPIACOS F.C. - Kifisia FC 1:1 | 20/12/2025 102
        Match match25201225 = matchRepository.findById("MA25201225").orElseThrow();
        List<PlayerMatch> playerMatches25201225 = List.of(
                new PlayerMatch("PM01992273", players.get("Tzolakis"), match25201225,
                        0, 0, 0, 0, 102),
                new PlayerMatch("PM02003789", players.get("Rodinei"), match25201225,
                        0, 0, 0, 0, 102),
                new PlayerMatch("PM03433178", players.get("Retsos"), match25201225,
                        0, 0, 0, 0, 102),
                new PlayerMatch("PM04505541", players.get("Pirola"), match25201225,
                        0, 0, 0, 0, 62),
                new PlayerMatch("PM05797649", players.get("Ortega"), match25201225,
                        0, 0, 0, 0, 102),
                new PlayerMatch("PM06964333", players.get("Hezze"), match25201225,
                        0, 0, 0, 0, 76),
                new PlayerMatch("PM07198923", players.get("Mouzakitis"), match25201225,
                        0, 0, 0, 0, 102),
                new PlayerMatch("PM08111415", players.get("Chiquinho"), match25201225,
                        0, 0, 0, 0, 102),
                new PlayerMatch("PM09888834", players.get("Taremi"), match25201225,
                        1, 0, 0, 0, 102),
                new PlayerMatch("PM10108764", players.get("Strefezza"), match25201225,
                        0, 0, 0, 0, 63),
                new PlayerMatch("PM11345678", players.get("Yaremchuk"), match25201225,
                        0, 0, 0, 0, 87),
                new PlayerMatch("PM12309872", players.get("Biancone"), match25201225,
                        0, 0, 0, 0, 40),
                new PlayerMatch("PM13993827", players.get("Martins"), match25201225,
                        0, 0, 0, 0, 39),
                new PlayerMatch("PM14555441", players.get("Nascimento"), match25201225,
                        0, 0, 0, 0, 26),
                new PlayerMatch("PM15855632", players.get("Yazici"), match25201225,
                        0, 0, 0, 0, 15)
        );
        ...
        setGKCleanSheet(playerMatches26030126, players.get("Tzolakis"));
        savePlayerMatchesAndUpdateTotalStats(playerMatches26030126, WIN);

        // Match 27 | Atromitos FC - OLYMPIACOS F.C. 0:2 | 10/01/2026
        Match match27100126 = matchRepository.findById("MA27100126").orElseThrow();
        List<PlayerMatch> playerMatches27100126 = List.of(
                new PlayerMatch("PM01877429", players.get("Tzolakis"), match27100126,
                        0, 0, 0, 0, 93),
                new PlayerMatch("PM02333339", players.get("Costinha"), match27100126,
                        0, 0, 0, 0, 93),
                new PlayerMatch("PM03112318", players.get("Retsos"), match27100126,
                        0, 0, 0, 0, 93),
                new PlayerMatch("PM04999982", players.get("Biancone"), match27100126,
                        0, 0, 1, 0, 93),
                new PlayerMatch("PM05540394", players.get("Ortega"), match27100126,
                        0, 0, 0, 0, 93),
                new PlayerMatch("PM06909871", players.get("Garcia"), match27100126,
                        0, 0, 0, 0, 93),
                new PlayerMatch("PM07481823", players.get("Hezze"), match27100126,
                        0, 1, 0, 0, 85),
                new PlayerMatch("PM08801415", players.get("Yazici"), match27100126,
                        0, 0, 0, 0, 69),
                new PlayerMatch("PM09910324", players.get("Chiquinho"), match27100126,
                        0, 1, 0, 0, 85),
                new PlayerMatch("PM10908841", players.get("Martins"), match27100126,
                        1, 0, 0, 0, 78),
                new PlayerMatch("PM11335787", players.get("Taremi"), match27100126,
                        1, 1, 0, 0, 85),
                new PlayerMatch("PM12421999", players.get("Nascimento"), match27100126,
                        0, 0, 0, 0, 24),
                new PlayerMatch("PM13636419", players.get("Strefezza"), match27100126,
                        0, 0, 0, 0, 15),
                new PlayerMatch("PM14555401", players.get("Kalogeropoulos"), match27100126,
                        0, 0, 0, 0, 8),
                new PlayerMatch("PM15890039", players.get("Mouzakitis"), match27100126,
                        0, 0, 0, 0, 8),
                new PlayerMatch("PM16663231", players.get("Yaremchuk"), match27100126,
                        0, 0, 1, 0, 8)
        );
        setGKCleanSheet(playerMatches27100126, players.get("Tzolakis"));
        savePlayerMatchesAndUpdateTotalStats(playerMatches27100126, WIN);

        // Match 28 | OLYMPIACOS F.C. - PAOK FC 0:2 | 14/01/2026
        Match match28140126 = matchRepository.findById("MA28140126").orElseThrow();
        List<PlayerMatch> playerMatches28140126 = List.of(
                new PlayerMatch("PM01009882", players.get("Tzolakis"), match28140126,
                        0, 0, 0, 0, 93),
                new PlayerMatch("PM02398483", players.get("Costinha"), match28140126,
                        0, 0, 1, 0, 45),
                new PlayerMatch("PM03665628", players.get("Retsos"), match28140126,
                        0, 0, 0, 0, 93),
                new PlayerMatch("PM04121382", players.get("Biancone"), match28140126,
                        0, 0, 1, 0, 80),
                new PlayerMatch("PM05945694", players.get("Ortega"), match28140126,
                        0, 0, 0, 0, 93),
                new PlayerMatch("PM06900001", players.get("Garcia"), match28140126,
                        0, 0, 0, 0, 64),
                new PlayerMatch("PM07765733", players.get("Mouzakitis"), match28140126,
                        0, 1, 0, 0, 85),
                new PlayerMatch("PM08348335", players.get("Martins"), match28140126,
                        0, 0, 0, 0, 69),
                new PlayerMatch("PM09919804", players.get("Chiquinho"), match28140126,
                        0, 0, 0, 0, 64),
                new PlayerMatch("PM10134671", players.get("Yazici"), match28140126,
                        0, 0, 0, 0, 32),
                new PlayerMatch("PM11098787", players.get("Taremi"), match28140126,
                        0, 0, 0, 0, 85),
                new PlayerMatch("PM12421229", players.get("Yaremchuk"), match28140126,
                        0, 0, 0, 0, 61),
                new PlayerMatch("PM13044319", players.get("Rodinei"), match28140126,
                        0, 0, 1, 0, 48),
                new PlayerMatch("PM14598001", players.get("Hezze"), match28140126,
                        0, 0, 0, 0, 29),
                new PlayerMatch("PM15155539", players.get("Podence"), match28140126,
                        0, 0, 0, 0, 29),
                new PlayerMatch("PM16694690", players.get("Kalogeropoulos"), match28140126,
                        0, 0, 0, 0, 13)
        );
        setGKGoalsConceded(playerMatches28140126, players.get("Tzolakis"), 2);
        savePlayerMatchesAndUpdateTotalStats(playerMatches28140126, LOSS);

        // Match 29 | OLYMPIACOS F.C. - Bayer 04 Leverkusen 2:0 | 20/01/2026
        Match match29200126 = matchRepository.findById("MA29200126").orElseThrow();
        List<PlayerMatch> playerMatches29200126 = List.of(
                new PlayerMatch("PM01087645", players.get("Tzolakis"), match29200126,
                        0, 0, 0, 0, 96),
                new PlayerMatch("PM02976211", players.get("Costinha"), match29200126,
                        1, 0, 0, 0, 96),
                new PlayerMatch("PM03454428", players.get("Retsos"), match29200126,
                        0, 0, 1, 0, 96),
                new PlayerMatch("PM04113782", players.get("Pirola"), match29200126,
                        0, 0, 0, 0, 74),
                new PlayerMatch("PM05540000", players.get("Ortega"), match29200126,
                        0, 0, 0, 0, 96),
                new PlayerMatch("PM06965437", players.get("Hezze"), match29200126,
                        0, 0, 0, 0, 96),
                new PlayerMatch("PM07671092", players.get("Mouzakitis"), match29200126,
                        0, 0, 0, 0, 74),
                new PlayerMatch("PM08989102", players.get("Rodinei"), match29200126,
                        0, 2, 0, 0, 96),
                new PlayerMatch("PM09555534", players.get("Chiquinho"), match29200126,
                        0, 0, 0, 0, 83),
                new PlayerMatch("PM10019191", players.get("Martins"), match29200126,
                        0, 0, 0, 0, 80),
                new PlayerMatch("PM11512123", players.get("Taremi"), match29200126,
                        1, 0, 1, 0, 74),
                new PlayerMatch("PM12498710", players.get("Garcia"), match29200126,
                        0, 0, 0, 0, 22),
                new PlayerMatch("PM13600019", players.get("Biancone"), match29200126,
                        0, 0, 0, 0, 22),
                new PlayerMatch("PM14590984", players.get("El Kaabi"), match29200126,
                        0, 0, 0, 0, 22),
                new PlayerMatch("PM15844449", players.get("Onyemaechi"), match29200126,
                        0, 0, 0, 0, 17),
                new PlayerMatch("PM16716771", players.get("Scipioni"), match29200126,
                        0, 0, 0, 0, 14)
        );
        ...
        Match match31280126 = matchRepository.findById("MA31280126").orElseThrow();
        List<PlayerMatch> playerMatches31280126 = List.of(
                new PlayerMatch("PM01098390", players.get("Tzolakis"), match31280126,
                        0, 0, 0, 0, 98),
                new PlayerMatch("PM02466831", players.get("Costinha"), match31280126,
                        0, 0, 1, 0, 98),
                new PlayerMatch("PM03433338", players.get("Retsos"), match31280126,
                        0, 0, 0, 0, 98),
                new PlayerMatch("PM04656151", players.get("Pirola"), match31280126,
                        0, 0, 0, 0, 28),
                new PlayerMatch("PM05545799", players.get("Ortega"), match31280126,
                        0, 0, 0, 0, 98),
                new PlayerMatch("PM06565534", players.get("Hezze"), match31280126,
                        1, 0, 1, 0, 98),
                new PlayerMatch("PM07987631", players.get("Mouzakitis"), match31280126,
                        0, 0, 0, 0, 75),
                new PlayerMatch("PM08987321", players.get("Rodinei"), match31280126,
                        0, 0, 0, 0, 90),
                new PlayerMatch("PM09099211", players.get("Taremi"), match31280126,
                        0, 1, 0, 0, 98),
                new PlayerMatch("PM10167434", players.get("Martins"), match31280126,
                        1, 0, 0, 0, 90),
                new PlayerMatch("PM11995111", players.get("El Kaabi"), match31280126,
                        0, 0, 0, 0, 75),
                new PlayerMatch("PM12988112", players.get("Biancone"), match31280126,
                        0, 0, 0, 0, 70),
                new PlayerMatch("PM13765559", players.get("Scipioni"), match31280126,
                        0, 0, 0, 0, 23),
                new PlayerMatch("PM14333314", players.get("Chiquinho"), match31280126,
                        0, 1, 0, 0, 23),
                new PlayerMatch("PM15083471", players.get("Onyemaechi"), match31280126,
                        0, 0, 0, 0, 8),
                new PlayerMatch("PM16090090", players.get("Podence"), match31280126,
                        0, 0, 0, 0, 8)
        );
        ...
        Match match35140226 = matchRepository.findById("MA35140226").orElseThrow();
        List<PlayerMatch> playerMatches35140226 = List.of(
                new PlayerMatch("PM01999831", players.get("Tzolakis"), match35140226,
                        0, 0, 0, 0, 98),
                new PlayerMatch("PM02498831", players.get("Rodinei"), match35140226,
                        0, 0, 1, 0, 70),
                new PlayerMatch("PM03466310", players.get("Biancone"), match35140226,
                        0, 0, 0, 0, 98),
                new PlayerMatch("PM04018211", players.get("Retsos"), match35140226,
                        0, 0, 0, 0, 98),
                new PlayerMatch("PM05745799", players.get("Onyemaechi"), match35140226,
                        0, 0, 0, 0, 84),
                new PlayerMatch("PM06188888", players.get("Hezze"), match35140226,
                        0, 0, 0, 0, 98),
                new PlayerMatch("PM07193431", players.get("Mouzakitis"), match35140226,
                        0, 0, 0, 0, 70),
                new PlayerMatch("PM08100000", players.get("Luiz"), match35140226,
                        0, 0, 0, 0, 98),
                new PlayerMatch("PM09061314", players.get("Chiquinho"), match35140226,
                        0, 0, 0, 0, 70),
                new PlayerMatch("PM10099911", players.get("Martins"), match35140226,
                        0, 0, 0, 0, 98),
                new PlayerMatch("PM11925331", players.get("El Kaabi"), match35140226,
                        0, 0, 0, 0, 98),
                new PlayerMatch("PM12987831", players.get("Costinha"), match35140226,
                        0, 0, 0, 0, 28),
                new PlayerMatch("PM13094531", players.get("Nascimento"), match35140226,
                        0, 0, 0, 0, 28),
                new PlayerMatch("PM14331555", players.get("Clayton"), match35140226,
                        0, 0, 0, 0, 28),
                new PlayerMatch("PM15717241", players.get("Yazici"), match35140226,
                        0, 0, 0, 0, 14)
        );
        setGKCleanSheet(playerMatches35140226, players.get("Tzolakis"));
        savePlayerMatchesAndUpdateTotalStats(playerMatches35140226, DRAW);

        // Match 36 | OLYMPIACOS F.C. - Bayer 04 Leverkusen 0:2 | 18/02/2026
        Match match36180226 = matchRepository.findById("MA36180226").orElseThrow();
        List<PlayerMatch> playerMatches36180226 = List.of(
                new PlayerMatch("PM01898723", players.get("Tzolakis"), match36180226,
                        0, 0, 0, 0, 101),
                new PlayerMatch("PM02574319", players.get("Rodinei"), match36180226,
                        0, 0, 0, 0, 101),
                new PlayerMatch("PM03443148", players.get("Retsos"), match36180226,
                        0, 0, 0, 0, 101),
                new PlayerMatch("PM04941152", players.get("Pirola"), match36180226,
                        0, 0, 0, 0, 53),
                new PlayerMatch("PM05175784", players.get("Ortega"), match36180226,
                        0, 0, 0, 0, 90),
                new PlayerMatch("PM06544234", players.get("Hezze"), match36180226,
                        0, 0, 0, 0, 90),
                new PlayerMatch("PM07998873", players.get("Mouzakitis"), match36180226,
                        0, 0, 0, 0, 101),
                new PlayerMatch("PM08448881", players.get("Martins"), match36180226,
                        0, 0, 0, 0, 101),
                new PlayerMatch("PM09044419", players.get("Taremi"), match36180226,
                        0, 0, 0, 0, 72),
                new PlayerMatch("PM10103004", players.get("Podence"), match36180226,
                        0, 0, 0, 0, 72),
                new PlayerMatch("PM11945977", players.get("El Kaabi"), match36180226,
                        0, 0, 1, 0, 101),
                new PlayerMatch("PM12777772", players.get("Biancone"), match36180226,
                        0, 0, 0, 0, 48),
                new PlayerMatch("PM13767779", players.get("Luiz"), match36180226,
                        0, 0, 0, 0, 29),
                new PlayerMatch("PM14541724", players.get("Chiquinho"), match36180226,
                        0, 0, 0, 0, 29),
                new PlayerMatch("PM15772576", players.get("Onyemaechi"), match36180226,
                        0, 0, 0, 0, 11),
                new PlayerMatch("PM16103333 ", players.get("Scipioni"), match36180226,
                        0, 0, 0, 0, 11)
        );
        setGKGoalsConceded(playerMatches36180226, players.get("Tzolakis"), 2);
        savePlayerMatchesAndUpdateTotalStats(playerMatches36180226, LOSS);

        // Match 37 | OLYMPIACOS F.C. - Panaitolikos FC 2:0 | 21/02/2026
        Match match37210226 = matchRepository.findById("MA37210226").orElseThrow();
        List<PlayerMatch> playerMatches37210226 = List.of(
                new PlayerMatch("PM01097878", players.get("Tzolakis"), match37210226,
                        0, 0, 0, 0, 96),
                new PlayerMatch("PM02555531", players.get("Costinha"), match37210226,
                        0, 0, 0, 0, 96),
                new PlayerMatch("PM03491910", players.get("Kalogeropoulos"), match37210226,
                        0, 0, 0, 0, 96),
                new PlayerMatch("PM04595431", players.get("Pirola"), match37210226,
                        1, 0, 0, 0, 96),
                new PlayerMatch("PM05987161", players.get("Onyemaechi"), match37210226,
                        0, 0, 0, 0, 84),
                new PlayerMatch("PM06733671", players.get("Garcia"), match37210226,
                        0, 0, 0, 0, 96),
                new PlayerMatch("PM07190921", players.get("Scipioni"), match37210226,
                        0, 0, 0, 0, 96),
                new PlayerMatch("PM08178841", players.get("Luiz"), match37210226,
                        0, 0, 0, 0, 84),
                new PlayerMatch("PM09312114", players.get("Nascimento"), match37210226,
                        0, 1, 0, 0, 96),
                new PlayerMatch("PM10106656", players.get("Chiquinho"), match37210226,
                        0, 1, 0, 0, 96),
                new PlayerMatch("PM11285481", players.get("Taremi"), match37210226,
                        0, 0, 0, 0, 72),
                new PlayerMatch("PM12188771", players.get("El Kaabi"), match37210226,
                        0, 0, 0, 0, 24),
                new PlayerMatch("PM13400259", players.get("Ortega"), match37210226,
                        0, 0, 1, 0, 29),
                new PlayerMatch("PM14000081", players.get("Yazici"), match37210226,
                        1, 0, 0, 0, 12)
        );
